...
Later releases may include vignettes, etc., documenting analses using the 
...
2. Refine "1" by deleting companies with high gdppc based on something narroe 
like a commodity, e.g., oil. 
...
6. Identify the world leader in `gdppc` for each year, refining "1" using KFAS 
interpolation. 
