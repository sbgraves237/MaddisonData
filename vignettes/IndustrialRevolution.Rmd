...
plotLeaders1 <- MaddisonData::plotMaddison(names(Leaders10))
```
...
Leaders1600 <- MaddisonLeaders(c('ARE', 'KWT', 'QAT'), 
                               data=MadDat1600)

table(Leaders1600$ISO)

plotLeaders1600 <- MaddisonData::plotMaddison(names(table(Leaders1600$ISO)))
